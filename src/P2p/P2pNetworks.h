...
namespace CryptoNote
{
  ...
  // lwma-2: 0x33, 0x44, 0x55 < don't use these either
  // your-testnet: vals here and PR please ;)

  const static boost::uuids::uuid BYTECOIN_NETWORK = { {  0x33, 0x44, 0x55, 0x6c, 0xcf, 0x52, 0x57, 0x41, 0x65, 0xf9, 0x91, 0xa4, 0xb6, 0xc1, 0x43, 0xe9  } };
